...
/*
compile: gcc -O0 -fopenmp sampleSort_v3.c -o sampleSort_v3
usage: ./sampleSort_v3 ARRAY_LEN THREAD_NUM
...
for(int i=start; i<=end; i++){
    ...
    // printf("bucket length: ");
    // for(int i=0; i<bucketNum; i++){
    //     printf("%d ", bucketPointer[i]);
    // }
    // printf("\n");
